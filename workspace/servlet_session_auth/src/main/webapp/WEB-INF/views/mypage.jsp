...
<body>
	<div class="container">
		...
		<div class="main-container">
			<div>
				<form class="mypage-form" action="/ssa/api/mypage/edit"
					method="post">
					<h1>MyPage</h1>
					<input class="mypage-input" name="username" placeholder="username"
						value="<%=user.getUsername()%>" disabled="disabled"> <input
						class="mypage-input" name="name" placeholder="name"
						value="<%=user.getName()%>"> <input class="mypage-input"
